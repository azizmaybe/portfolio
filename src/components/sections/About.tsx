        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <p className="text-[#C8C8C8] text-[1.1rem] leading-[1.6]">
              Specializing in cross-platform mobile development and
              high-performance web applications, I bring a racing team&apos;s
              focus on precision and speed to every codebase I touch.
            </p>
          </motion.div>
          ...
          >
            <span className="font-['JetBrains_Mono',_monospace] text-xs text-[#E8002D] uppercase tracking-widest block mb-8">
              Performance Specs
            </span>
            ...
            <div className="mt-12">
              ...
              <div className="flex gap-8">
                <a
                  ...
                  className="text-[#E8002D] font-black hover:text-white transition-colors"
                >
                  LINKEDIN
                </a>
                <a
