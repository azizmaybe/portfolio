...
const Contact = () => {
  const { formData, handleChange, sendEmail, isSubmitting, success, error } =
    useContactForm();
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <p className="text-[#C8C8C8] text-[1.2rem] leading-[1.8] mb-8">
              ...
              discuss the latest tech in Flutter and Web, I&apos;m always open
              to new connections.
            </p>

            <div className="mb-8">
              <span className="font-['JetBrains_Mono',_monospace] text-xs text-[#E8002D] uppercase tracking-widest block mb-2">
                Direct Communication
              </span>
              <a
                href={`mailto:${profileData.socials.email}`}
                className="text-[1.5rem] font-bold text-[#E8002D] block mb-2 break-all"
              >
            ...
            <div>
              ...
              <div className="flex gap-6 mt-4">
                <a
                  ...
                  className="font-black hover:text-[#E8002D] transition-colors"
                >
                  LINKEDIN
                </a>
                <a
          ...
          >
            <form onSubmit={sendEmail}>
              <div className="mb-8">
                <label
                  className="font-['JetBrains_Mono',_monospace] text-xs text-[#E8002D] uppercase tracking-widest block mb-2"
                  htmlFor="name"
                >
                  Full Name
                </label>
                <input
                  ...
                  required
                  className="w-full p-4 bg-white/10 border-b-2 border-white/20 text-white outline-none transition-colors duration-300 focus:border-[#E8002D] rounded-t-lg focus:bg-white/20"
                />
              </div>
              ...
              <div className="mb-12">
                ...
                <textarea
                  ...
                  required
                  rows={4}
                  className="w-full p-4 bg-white/10 border-b-2 border-white/20 text-white outline-none resize-none transition-colors duration-300 focus:border-[#E8002D] rounded-t-lg focus:bg-white/20"
                />
              </div>
